...
import application.by.incubator.Engins.DieselEngine;
import application.by.incubator.Engins.ElectricalEngine;
import application.by.incubator.Engins.GasolineEngine;
...
public class ParserVehicleFromFile {
    ...
    public void display(List<Vehicle> vehicles) {
        System.out.println(String.format("%3s %10s %20s %12s %15s %7s %10s %10s %10s %10s %10s",
                "Id", "Type", "ModelName", "Number", "Weight (kg)", "Year", "Millage", "application.by.incubator.Vehicle.Color", "Income", "Tax", "Profit"));
